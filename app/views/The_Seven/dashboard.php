...
<head>
    ...
    <link rel="stylesheet" href="<?= ASSETSCSS ?>The_Seven/dashboard2_theseven.css"">
</head>
<body data-assets-img="<?= ASSETSIMG ?>">
    ...
    <section class="container-1">
        ...
        <div class="dashboard-cards">
            <!-- Card 1 -->
            <a href="<?= BASEURL ?>TheSeven/TeamMember" class="card">
            ...
            <!-- Card 2 -->
            <a href="DASHBOARD/missions2_theseven.html" class="card">
            ...
            <!-- Card 3 -->
            <a href="DASHBOARD/user2_theseven.html" class="card">
    ...
    <script src="<?= ASSETSJS ?>The_Seven/dashboard2_theseven.js"></script>
</body>
</html>
